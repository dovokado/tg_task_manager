# SKILL: <PROJECT NAME> — workflow

> The project workflow. Claude reads this FIRST, before writing code or docs.
> Location: `.claude/skills/<name>/SKILL.md` in the project
> (or simpler: `docs/SKILL.md`, referenced from the project CLAUDE.md).
...
## Work sequence
1. Read the project `CLAUDE.md` + this `SKILL.md` + `project_<name>.md` (state).
...
- [ ] `project_<name>.md` updated (status / backlog)
